...
void CameraDrawComponent::handle_dispatch() {
  Magnum::SceneGraph::DrawableGroup3D *background_drawables = blackboard->magnum_blackboard->_background_drawables;
  Magnum::SceneGraph::DrawableGroup3D *drawables = blackboard->magnum_blackboard->_drawables;
